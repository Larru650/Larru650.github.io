...
export function CrossCircleGreyIcon({ className, style }: { className?: string; style?: CSSProperties }): JSX.Element {
  ...
  return (
    <svg className={className} style={style} viewBox="0 0 512 512">
      ...
      <g>
        <circle cx="256" cy="256" r="256" mask={`url(#${idPrefix}-clip-cross)`} fill="rgb(83, 98, 105)" />
      </g>
    </svg>
  );
}
